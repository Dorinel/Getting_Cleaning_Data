...
#### Note:
#### For a much longer script a ReadMe file should explain the script in less details. For example: only groups of commands may be explained in more details.
#### Here, while the script is much shorter I decided to explain the commands almost line_by_line for clarity and learning 
